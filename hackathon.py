...
if ans!=1:
   ...
   print("Good")   
lowerBP= int(input("Enter your lower BloodPressure value\n"))
highBP= int(input("Enter your higher BloodPressure value\n"))
...
if A!=1 or B!=1 or C!=1 or D!=1:
   ...
   print("Answer these questions to know the best game for exercising your mind\n")
   #Amnesia
